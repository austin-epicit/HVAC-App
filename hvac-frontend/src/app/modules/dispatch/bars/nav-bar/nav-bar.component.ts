...
@Component({
	...
	template: ` <p-panelMenu [model]="items" class="nav-bar"></p-panelMenu> `,
	styles: [
		`
			:host {
				display: block;
	...
	items: MenuItem[] = [
		{
			...
			routerLink: ['/dispatch/dashboard'],
		},
		{
			label: 'Jobs',
			icon: 'pi pi-fw pi-briefcase',
			routerLink: ['/dispatch/jobs'],
		},
		{
			label: 'Schedule',
			icon: 'pi pi-fw pi-calendar',
			routerLink: ['/dispatch/schedule'],
		},
		{
			label: 'Inventory',
			icon: 'pi pi-fw pi-box',
			routerLink: ['/dispatch/inventory'],
		},
